...
public class FeatureFrameRender extends FrameRender {

    private PoseEstimationSolver mPoseEstimationSolver;

    public FeatureFrameRender(PoseEstimationSolver mPoseEstimationSolver) {
    ...
    public Mat render(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        mPoseEstimationSolver.renderFeatureExtractionFrame(rgbaFrame);
        return rgbaFrame;
    }
}
