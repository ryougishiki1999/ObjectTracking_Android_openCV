...
public class Transform {
    ...
    public static void convertRTToTransform(@NonNull Mat R, @NonNull Mat T, @NonNull Mat transform) {
        Log.d(TAG, "R: " + R.dump());
        Log.d(TAG, "T: " + T.dump());
    ...
    public static void TransformConvertToRT(@NonNull Mat transform, @NonNull Mat R, @NonNull Mat T) {
        Log.d(TAG, "transform: " + transform.dump());
